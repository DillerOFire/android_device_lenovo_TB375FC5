...
# OTA to ZUI 17.5.10.103. Run with no arg to (re)generate makefiles from
...
if __name__ == '__main__':
    ...
    # Remove the duplicate chipinfo Soong module after standard extraction.
    import postprocess_vendor_blobs
    postprocess_vendor_blobs.main()
